                ...
                <div className="casues-sidebar-wrapper">
                  ...
                  <div className="single-sidebar-widgets">
                    ...
                    <div className="causue-gallery-wid">
                      <a
                        href="/assets/img/news/04.jpg"
                        className="single-cause-img img-popup bg-cover"
                        style={{
                          backgroundImage: 'url("/assets/img/news/04.jpg")',
                        }}
                      />
                      <a
                        href="/assets/img/news/05.jpg"
                        className="single-cause-img img-popup"
                        style={{
                          backgroundImage: 'url("/assets/img/news/05.jpg")',
                        }}
                      />
                      <a
                        href="/assets/img/news/06.jpg"
                        className="single-cause-img img-popupy"
                        style={{
                          backgroundImage: 'url("/assets/img/news/06.jpg")',
                        }}
                      />
                      <a
                        href="/assets/img/hero/hero-5.jpg"
                        className="single-cause-img img-popup mb-0"
                        style={{
                          backgroundImage: 'url("/assets/img/hero/hero-5.jpg")',
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: 'url("/assets/img/hero/hero-6.jpg")',
                    }}
                  >
